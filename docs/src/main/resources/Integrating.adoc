...
a|\http://<DISTRIBUTION_HOST>:<DISTRIBUTION_PORT>/services/catalog/<metacardId>
...
a|\http://<DISTRIBUTION_HOST>:<DISTRIBUTION_PORT>/services/catalog/sources/<sourceId>/<metacardId>
...
a|\http://<DISTRIBUTION_HOST>:<DISTRIBUTION_PORT>/services/catalog/sources/
